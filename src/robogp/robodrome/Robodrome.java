...
public class Robodrome {
    ...
    private Map<Integer,FloorCell> docks;
    private String path;
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < columns; c++) {
                ...
                if (board[r][c] instanceof FloorCell && ((FloorCell)board[r][c]).isDock()) {
                    FloorCell temp_dock = (FloorCell)board[r][c];
                    temp_dock.set_dock_rc(r,c);
                    docks.put( temp_dock.getDock() , temp_dock); 
                    this.docksCount++;
                }
                if (board[r][c] instanceof FloorCell && ((FloorCell)board[r][c]).isCheckpoint()) {                    
                    this.checksCount++;
                }
            }
        }
    ...
    public FloorCell getDock(int index){
